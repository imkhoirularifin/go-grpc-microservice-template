...
import (
	v1 "github.com/imkhoirularifin/go-grpc-microservice-template/gen/go/common/v1"
...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x1acommon/v1/pagination.proto\"_\n" +
	"\x04User\x12\x0e\n" +
	...
	"\tListUsers\x12\x19.user.v1.ListUsersRequest\x1a\x1a.user.v1.ListUsersResponseB\xa5\x01\n" +
	"\vcom.user.v1B\tUserProtoP\x01ZNgithub.com/imkhoirularifin/go-grpc-microservice-template/gen/go/user/v1;userv1\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	5, // 1: user.v1.ListUsersRequest.pagination:type_name -> common.v1.PaginationRequest
	0, // 2: user.v1.ListUsersResponse.users:type_name -> user.v1.User
	6, // 3: user.v1.ListUsersResponse.pagination:type_name -> common.v1.PaginationResponse
	1, // 4: user.v1.UserService.GetUser:input_type -> user.v1.GetUserRequest
	3, // 5: user.v1.UserService.ListUsers:input_type -> user.v1.ListUsersRequest
